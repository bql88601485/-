                   ...
                   withKey:(NSString *)key
{
    ...
    NSData *data = [[NSData alloc] initWithBase64Encoding:[[dataStruct data] base64Encoding]];
...
+ (DataStruct *)dataStructWithModule:(NSString *)module withKey:(NSString *)key
{
    ...
    NSString *base64Str = [[[NSData alloc] initWithContentsOfFile:filePath] base64Encoding];
    if (base64Str == nil)
    {
        return nil;
    }
...
+ (id)objectWithModule:(NSString *)module withKey:(NSString *)key withMerge:(id<MergeDataStoragePrt>)merge
{
    ...
    else
    {
        ...
        {
            return [merge mergeDataWithOriginData:[dataStruct dataVaule] withAppVID:[dataStruct appVID] withStructVersion:[dataStruct structVersion] withDataVersion:[dataStruct dataVersion] withModule:module withKey:key];
        }
    }
