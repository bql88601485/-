...
- (NaviBar *)initWithFrame:(CGRect)frameInit
{
    if((self = [super initWithFrame:frameInit]) != nil)
    {
        ...
        [_viewBG setBackgroundColor:[UIColor MainNavColor]];
        ...
        //        [titleArrow setImage:[UIImage imageWithBundlePath:kNavigationBarTitleArrowImageFile]];
...
- (void)setTitleColor:(UIColor *)titleNew{
    ...
    if([_viewTitle isKindOfClass:[LightControl class]])
    {
        ...
        if (titleLabel != nil)
        {
            [titleLabel setTextColor:titleNew];
        }
    }
}
...
- (void)reLayout
{
    ...
    if((_viewTitle != nil) && ([_viewTitle isHidden] == NO))
    {
        ...
        // 重新设置Frame属性
        if((_viewLeft != nil) && ([_viewLeft isHidden] == NO)){
            [_viewTitle setFrame:CGRectMake(_viewLeft.right, spaceYStart,
