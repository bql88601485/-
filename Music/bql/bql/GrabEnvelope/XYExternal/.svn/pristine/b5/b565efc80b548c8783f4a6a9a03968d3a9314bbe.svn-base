...
+ (id)defaultSettings{
    // 参考
    NSString *httpUrl = [XYPerformance getHttpUrl];
    httpUrl = [NSString stringWithFormat:@"%@/WebService1.asmx",httpUrl];
    RequestHelper *eg = [[RequestHelper alloc] initWithHostName:httpUrl customHeaderFields:@{@"x-client-identifier" : @"iOS"}];
