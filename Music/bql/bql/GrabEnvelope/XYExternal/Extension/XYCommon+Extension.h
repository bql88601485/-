...
#define SHOWMBProgressHUD1(aTitle, aMsg, aImg, aDimBG, aDelay, addVC) [XYCommon showMBProgressHUDTitle:aTitle msg:aMsg image:aImg dimBG:aDimBG delay:aDelay addVC1:addVC];
+ (MBProgressHUD *)showMBProgressHUDTitle:(NSString *)aTitle msg:(NSString *)aMsg image:(UIImage *)aImg dimBG:(BOOL)dimBG delay:(float)d addVC1:(UIViewController *)addVC;
