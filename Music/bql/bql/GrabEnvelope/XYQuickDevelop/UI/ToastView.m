...
+ (void)showMessage:(NSString*)msg disappearAfterTime:(int)time
{
    ...
    UIWindow *window = [ToastView getKeyboardWindow];
...
{
    [ToastView showMessage:msg disappearAfterTime:CSToastDefaultDuration];
...
+ (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        if(expectedSizeTitle.width < screenBounds.size.width * CSToastMinWidth)
            expectedSizeTitle.width = screenBounds.size.width * CSToastMinWidth;
    ...
    if (message != nil) {
        ...
        if(expectedSizeMessage.width < screenBounds.size.width * CSToastMinWidth)
            expectedSizeMessage.width = screenBounds.size.width * CSToastMinWidth;
